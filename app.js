...
function p1Legs(week) {
  ...
  return [
    ...
    ex('Walking Lunge', 1, [w(2, '10/leg', '8–9', '~2–3 min')],
...
function p1Push(week) {
  ...
  return [
    ex('Bench Press', 4, [w(1, bReps, '8–9', '~3–4 min')],
      ['DB Bench Press', 'Machine Chest Press'],
      'Comfortable arch, quick pause on chest, explode up.'),
    ex('Larsen Press', 0, [w(2, '10', '8–9', '~3–4 min')],
      ['DB Bench (No Leg Drive)', 'Machine Chest Press (No Leg Drive)'],
    ...
    ex('A1: Press-Around (Cable)', 1, [w(2, '12–15', '9–10', '0 min — superset')],
      ['DB Flye', 'Deficit Push-Up'],
...
function p1Pull(week) {
  ...
  return [
    ...
    ex('Omni-Grip Machine Chest-Supported Row', 2, [w(3, '10–12', '8–9', '~2–3 min')],
      ['Incline CS DB Row', 'Cable Seated Row'],
...
var P1_W6 = {
  Legs: [
    ...
    ex('Walking Lunge', 1, [w(2, '10/leg', '7', '~2–3 min')], ['DB Step-Up', 'Goblet Squat']),
  ...
  Push: [
    ex('Bench Press', 4, [w(1, '3–5', '7', '~3–4 min')], ['DB Bench Press', 'Machine Chest Press']),
    ex('Larsen Press', 0, [w(2, '10', '7', '~3–4 min')], ['DB Bench (No Leg Drive)', 'Machine (No Leg Drive)']),
    ex('Standing DB Arnold Press', 2, [w(2, '8–10', '7', '~2–3 min')], ['Seated DB Press', 'Machine Shoulder Press']),
    ex('A1: Press-Around (Cable)', 1, [w(2, '12–15', '8', '0 min — superset')], ['DB Flye', 'Deficit Push-Up']),
    ex('A2: Pec Static Stretch', 0, [w(2, '30s hold', 'N/A', '0 min — superset')], []),
  ...
  Pull: [
    ...
    ex('Omni-Grip Machine Chest-Supported Row', 2, [w(3, '10–12', '7', '~2–3 min')], ['Incline CS DB Row', 'Cable Seated Row'], '3 grips: wide → medium → close.'),
...
var P3_LEGS_BASE = [
  ...
  ex('Walking Lunge', 1, [w(3, '10/leg', '9', '~2–3 min')],
    ['DB Step-Up', 'Goblet Squat'],
...
var P3_W3 = {
  Legs: [
    ...
    ex('Walking Lunge', 1, [w(2, '8/leg', '6', '~2–3 min')], ['DB Step-Up', 'Goblet Squat']),
  ...
  'Full Body': [
    ...
    ex('Bench Press', 4, [w(1, '2–4', '6', '~3–4 min')], ['DB Bench Press', 'Machine Chest Press']),
    ex('Pull-Up — Cluster Sets', 2, [w(4, '3', '6', '15 sec between clusters')], ['Lat Pulldown', 'Machine Pulldown']),
    ex('Leg Press', 3, [w(1, '12', '6', '~2–3 min')], ['Goblet Squat', 'Walking Lunge']),
